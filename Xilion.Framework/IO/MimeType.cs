...
namespace Xilion.Framework.IO
{
    ...
    {
        private static readonly IDictionary<string, string> _types;
        ...
        {
            Guard.IsNotNullOrEmpty(extension, "extension");
            extension = extension.ToLower();
            return _types.ContainsKey(extension) ? _types[extension] : "application/octet-stream";
        }
    }
}