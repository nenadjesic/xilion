...
namespace Xilion.Models.Site.Data.Mappings.Conventions
{
    ...
    /// </summary>
    public class DynamicDataType : ImmutableUsersType<DynamicData>
    {
            ...
            return new DynamicData()
                       {
                           Properties = serializedProperties != null
                                            ? Serializer.Default()
                                                  .Deserialize<IList<DynamicDataProperty>>(serializedProperties)
                                            : new List<DynamicDataProperty>(),
                           IsChanged = false
                       };
        }
        ...
        {
            var widgetData = value as DynamicData;

            object valueToSet =
                widgetData == null
                    ? DBNull.Value
                    : (object) Serializer.Default()
                                   .Serialize<IList<DynamicDataProperty>>(widgetData.Properties);
